...
const [formData,setFormData] = useState({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if(id){
        await axiosInstance.put(`/branches/${id}`, formData);
        await showFormSubmitToast('Location updated successfully!', 
          () => navigate('/branch/branch-list'));
      } else{
        await axiosInstance.post('/branches', formData);
        await showFormSubmitToast('Location added successfully!', 
          () => navigate('/branch/branch-list'));
      }
    } catch (error) {
